 ...
 * The model needs an assigned baseline category to be indentifiable. All other choices are evaluated in contrast to this reference.
 * The model returns a set of coefficients for each choice category.
 * Like all logit models, the multinomial logit model returns logg-ods which are difficult to interpret in terms of effect sizes and uncertainties.
